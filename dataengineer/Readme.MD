...
7.	**Select** the "X" on the Activity Status monitor window to close the window.
8. **Select** the menu control button on the far left side to bring back the Data Connect main menu.
