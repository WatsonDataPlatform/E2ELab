...
4. Select the check mark button next to the Activity name you entered to save the new name.  
...
7. **Select** the menu visibility button on the far left side to bring back the main menu on the left.
