...
> If you are not in the "Watson Data Platform" space, that you were instructed to create in the GettingStarted section, switch to it by followimg the instructions below.
...
1. Once you are logged into your Bluemix account, **Scroll down** to the "All Services" section of your dashboard and **Click On** the "WDP Data Connect" service. You will be brought to the Data Connect launch page.
...
1. **Select** the “Connections” button at the bottom of the home page.  
