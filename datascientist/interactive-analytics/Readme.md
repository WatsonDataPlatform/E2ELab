...
If you have not visited the Getting Started section - please do so now and create your "dashDB for Analytics" service.

---
Step 1. Create a project and a connection to DashDB
